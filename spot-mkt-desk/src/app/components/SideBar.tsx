...
function Sidebar() {
  return (
    <aside className="group fixed md:relative top-0 left-0 z-50 h-screen w-14 md:w-60 bg-primary text-white transition-all duration-300 ease-in-out hover:w-60 overflow-hidden">
